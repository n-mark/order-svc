...
Микросервис заказов для маркетплейса объявлений (финальный проект). Оркестрирует жизненный цикл заказа: создание, оплату (через биллинг) и доставку. Написан на Go.
